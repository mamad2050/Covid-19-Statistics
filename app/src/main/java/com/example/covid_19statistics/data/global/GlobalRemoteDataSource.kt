...
class GlobalRemoteDataSource(private val apiService: ApiService) : GlobalDataSource {
    ...
    override fun getYesterdayStatistic(): Single<Global> = apiService.getGlobalYesterday()

    override fun getHistory(location: String): Single<JsonObject> = apiService.getHistory(location)
